...
__decorate([
    ...
    (0, log_decorator_1.Log)({ module: '角色管理', type: 'CREATE', description: '创建角色' }),
...
__decorate([
    ...
    (0, log_decorator_1.Log)({ module: '角色管理', type: 'UPDATE', description: '修改角色' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
...
__decorate([
    ...
    (0, require_permissions_decorator_1.RequirePermissions)('system:role:delete'),
    (0, log_decorator_1.Log)({ module: '角色管理', type: 'DELETE', description: '删除角色' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Post)(':id/assign-menus'),
    (0, require_permissions_decorator_1.RequirePermissions)('system:role:update'),
    (0, log_decorator_1.Log)({ module: '角色管理', type: 'UPDATE', description: '分配角色菜单权限' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
